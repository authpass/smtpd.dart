...
class _$MailObjectTearOff {
  ...
  _MailObject call({required MailEnvelope envelope, String? content}) {
    return _MailObject(
      envelope: envelope,
      content: content,
    );
...
class _$_MailObject implements _MailObject {
  const _$_MailObject({required this.envelope, this.content});
...
abstract class _MailObject implements MailObject {
  const factory _MailObject({required MailEnvelope envelope, String? content}) =
      _$_MailObject;
